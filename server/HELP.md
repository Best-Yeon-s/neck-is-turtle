...
* The original package name 'com.example.neck-is-turtle-back' is invalid and this project uses 'com.example.neckisturtleback' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/docs/2.6.12/reference/htmlsingle/#web.security.oauth2.client)
