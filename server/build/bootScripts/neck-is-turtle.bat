...
set JARPATH=%APP_HOME%\lib\neck-is-turtle-0.0.1-SNAPSHOT.jar

@rem Execute neck-is-turtle
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NECK_IS_TURTLE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%NECK_IS_TURTLE_EXIT_CONSOLE%" exit 1
exit /b 1
